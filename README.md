...
Create a DSH credential (Settings → Credentials, or the CLI) named e.g. `IMAGE_API_KEY` holding your key, then add a source in **Settings → 插件配置 → imagen** or directly in `~/.dsh/cordis.patch.yml`:
