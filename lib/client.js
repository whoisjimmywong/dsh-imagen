...
function ImagenSettingsCard({ t, loadConfig, saveConfig }) {
	...
	const dirty = (0, react.useMemo)(() => hasKeys || JSON.stringify(buildDraft()) !== JSON.stringify(value ?? {}), [
		sourceRows,
		defaultSource,
		saveEnabled,
		saveDir,
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: "dshImagenCard",
		"data-open": open,
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
			type: "button",
			className: "dshImagenCard__header",
			onClick: () => {
				setOpen((value$1) => !value$1);
			},
			"aria-expanded": open,
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				className: "dshImagenCard__heading",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					className: "dshImagenCard__title",
					children: t("settingsTitle")
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					className: "dshImagenCard__subtitle",
					children: t("settingsIntro")
				})]
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				className: `dshImagenCard__chevron${open ? " dshImagenCard__chevron--open" : ""}`,
				width: "16",
				height: "16",
				viewBox: "0 0 16 16",
				fill: "none",
			...
			children: [
				...
				phase === "ready" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
												...
												hint: row.credentialSet ? t("settingsKeySaved") : t("settingsKeyNotSet"),
												children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
													className: "dshImagenSet__input",
													type: "password",
													value: row.key,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dshImagenCard__footer",
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: "dshImagenSet__button",
...
function installPluginCard(ctx, t, call) {
	...
	const saveConfig = async (config, keys) => {
		const value = await call("imagen/settings/set", {
			config,
			keys
		}, signal);
		if (typeof value !== "object" || value === null) throw new Error("Host returned invalid settings");
...
const en = {
	...
	settingsCredentialHint: "Name under which the API key is stored in DSH credentials.",
	settingsApiKey: "API key",
	settingsKeySaved: "Saved. Leave empty to keep it.",
	settingsKeyNotSet: "Not set. Type a key and save to store it.",
...
const zh = {
	...
	settingsCredentialHint: "API 密钥在 DSH 凭据库中的存储名称。",
	settingsApiKey: "API 密钥",
	settingsKeySaved: "已保存，留空即不改动",
	settingsKeyNotSet: "未设置，输入密钥后保存",
